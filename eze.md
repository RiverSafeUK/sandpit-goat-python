...
![medium](https://img.shields.io/static/v1?style=plastic&label=medium&message=44&color=yellow)
...
---
    ...
    =================================
    TOOL REPORT: [github] python-safety (scan duration: 10.2 seconds)
...
https://github.com/pypa/pip/issues/9827
    ...
    TOOL REPORT: [github] trufflehog (scan duration: 0.4 seconds)
        total: 36 (medium:31, low:5)
        ignored: 0 

        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2123 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match:                 "text": "'Consider possible security implications associated with the subprocess module.', in .\\insecure\\src\\super-insecure-lib.py Investigate '.\\insecure\\src\\super-insecure-lib.py' Line 1 for 'Consider possible security implications associated with the subprocess module.' strings Full Match: 1 import subprocess\n2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \"\n4 \n "
        file: eze.sarif (line 2123)

        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2425 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match:             "text": "Investigate '.\\insecure\\src\\super-insecure-lib.py' Line 3 for 'Possible hardcoded password: 'ssh-rsa \nYF0ZF+OR'' strings Full Match: 2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \nYF0ZF+OR\"\n4 \n5 INSECURE_URL_WITH_HARDCODED_BASIC_AUTH = \"https://admin:god@hackers.com\"\n "
        ...
        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2385 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match:             "text": "Investigate '.\\insecure\\src\\super-insecure-lib.py' Line 1 for 'Consider possible security implications associated with the subprocess module.' strings Full Match: 1 import subprocess\n2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \nYF0ZF+OR\"\n4 \n "
        file: eze.sarif (line 2385)

        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2405 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match:             "text": "Investigate '.\\unpinned-requirements\\src\\super-insecure-lib.py' Line 1 for 'Consider possible security implications associated with the subprocess module.' strings Full Match: 1 import subprocess\n2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \nYF0ZF+OR\"\n4 \n "
        file: eze.sarif (line 2405)

        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2153 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match: <on long line (1204 characters)>
        ...
        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2143 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match: <on long line (1178 characters)>
        ...
        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2445 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match:             "text": "Investigate '.\\unpinned-requirements\\src\\super-insecure-lib.py' Line 3 for 'Possible hardcoded password: 'ssh-rsa \nYF0ZF+OR'' strings Full Match: 2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \nYF0ZF+OR\"\n4 \n5 INSECURE_URL_WITH_HARDCODED_BASIC_AUTH = \"https://admin:god@hackers.com\"\n "
        ...
        [MEDIUM SECRET] : Found Hardcoded 'High Entropy' Pattern
        overview: Found Hardcoded 'High Entropy' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2133 for 'High Entropy' strings (add '# nosecret' to line if false positive) Full Match:                 "text": "'Consider possible security implications associated with the subprocess module.', in .\\unpinned-requirements\\src\\super-insecure-lib.py Investigate '.\\unpinned-requirements\\src\\super-insecure-lib.py' Line 1 for 'Consider possible security implications associated with the subprocess module.' strings Full Match: 1 import subprocess\n2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \"\n4 \n "
        ...
        recommendation: Investigate 'eze.sarif' Line 2153 for 'Password in URL' strings (add '# nosecret' to line if false positive) Full Match: <on long line (1204 characters)>
        file: eze.sarif (line 2153)

        [LOW SECRET] : Found Hardcoded 'Password in URL' Pattern
        overview: Found Hardcoded 'Password in URL' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2143 for 'Password in URL' strings (add '# nosecret' to line if false positive) Full Match: <on long line (1178 characters)>
        file: eze.sarif (line 2143)

        [LOW SECRET] : Found Hardcoded 'Password in URL' Pattern
        overview: Found Hardcoded 'Password in URL' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2425 for 'Password in URL' strings (add '# nosecret' to line if false positive) Full Match:             "text": "Investigate '.\\insecure\\src\\super-insecure-lib.py' Line 3 for 'Possible hardcoded password: 'ssh-rsa \nYF0ZF+OR'' strings Full Match: 2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \nYF0ZF+OR\"\n4 \n5 INSECURE_URL_WITH_HARDCODED_BASIC_AUTH = \"https://admin:god@hackers.com\"\n "
        file: eze.sarif (line 2425)

        [LOW SECRET] : Found Hardcoded 'Password in URL' Pattern
        overview: Found Hardcoded 'Password in URL' Pattern in eze.sarif
        recommendation: Investigate 'eze.sarif' Line 2445 for 'Password in URL' strings (add '# nosecret' to line if false positive) Full Match:             "text": "Investigate '.\\unpinned-requirements\\src\\super-insecure-lib.py' Line 3 for 'Possible hardcoded password: 'ssh-rsa \nYF0ZF+OR'' strings Full Match: 2 \n3 INSECURE_SECRET_RSA_KEY = \"ssh-rsa \nYF0ZF+OR\"\n4 \n5 INSECURE_URL_WITH_HARDCODED_BASIC_AUTH = \"https://admin:god@hackers.com\"\n "
        file: eze.sarif (line 2445)
